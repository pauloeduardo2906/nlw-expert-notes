  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed inset-0 md:inset-auto md:left-1/2 md:top-1/2 flex md:h-[60vh] w-full md:max-w-[640px] md:-translate-x-1/2 md:-translate-y-1/2 flex-col overflow-hidden md:rounded-md bg-slate-700 outline-none">
          ...
          <form className="flex flex-1 flex-col">
            ...
            {isRecording ? (
              <button
                ...
                className="group w-full bg-slate-900 py-4 text-center text-sm font-medium text-slate-300 outline-none transition-all hover:text-slate-100 flex items-center justify-center gap-2"
              >
              ...
              <button
                ...
                className="group w-full bg-lime-400 py-4 text-center text-sm font-medium text-lime-950 outline-none transition-all hover:bg-lime-500"
              >
                Salvar nota
              </button>
            )}
